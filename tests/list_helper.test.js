...
const listWithMoreBlogs = [...listWithSeveralBlogs, {
...
describe('most blogs', () => {
    ...
    test('when list has only one blog equals given author and one blog', () => {
...
describe('most likes', () => {
    ...
    test('when list has only one blog equals given author and the likes of that', () => {
